 ...
 *
 * Custom error classes and error handling helpers for Looker API.
 */

/**
 * Base Looker API error
 */
 ...
 */
export class RateLimitError extends LookerApiError {
 ...
 */
export class AuthenticationError extends LookerApiError {
 ...
 * Not found error
 */
export class NotFoundError extends LookerApiError {
 ...
 * Validation error
 */
export class ValidationError extends LookerApiError {
